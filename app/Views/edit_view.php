                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 mb-2">
                        <div class="form-group">
                            ...
                            <select class="form-control form-select" id="sel_prov_edit" name="prov" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-select" id="sel_kota_edit" name="kota" required>
                              <option value="">---Pilih Kabupaten/Kota---</option>
                            </select>
                        </div>                        
                        <div class="form-group">
                            <label for="kecamatan" class="col-form-label">&nbsp</label>
                            <select class="form-control form-select" id="sel_kec_edit" name="kec" required>
                              <option value="">---Pilih Kecamatan---</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="desa" class="col-form-label">&nbsp</label>
                            <select class="form-control form-select" id="sel_desa_edit" name="desa" required>
